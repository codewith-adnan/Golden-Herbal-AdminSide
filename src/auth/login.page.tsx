    ...
    return (
        <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center p-6 relative overflow-hidden">
            ...
            <div className="w-full max-w-md relative z-10 transition-all duration-500 animate-in fade-in slide-in-from-bottom-8">
                ...
                <div className="bg-[#111111]/80 backdrop-blur-xl border border-[#d4af37]/20 rounded-[32px] overflow-hidden shadow-[0_20px_60px_rgba(212,175,55,0.15)]">
                    ...
                    <div className="p-8 text-center bg-gradient-to-b from-[#d4af37]/10 to-transparent border-b border-[#d4af37]/10">
                        ...
                        <h1 className="text-3xl font-serif font-bold bg-gradient-to-r from-[#d4af37] to-white bg-clip-text text-transparent tracking-tight mb-2">
                            Golden Herbal Command Center                        </h1>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative group">
                                    <div className="absolute inset-y-0 left-2 p-2 flex items-center pointer-events-none">
                                    ...
                                    <input
                                        ...
                                        className="block w-full pl-12 pr-4 py-3 bg-black/40 border border-[#d4af37]/10 rounded-2xl text-white placeholder-gray-600 focus:outline-none focus:border-[#d4af37]/50 focus:ring-1 focus:ring-[#d4af37]/50 transition-all"
                                    />
                                </div>
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative group">
                                    ...
                                    <input
                                        ...
                                        onChange={handleChange}
                                        placeholder="••••••••"
                                        className="block w-full pl-12 pr-12 py-3 bg-black/40 border border-[#d4af37]/10 rounded-2xl text-white placeholder-gray-600 focus:outline-none focus:border-[#d4af37]/50 focus:ring-1 focus:ring-[#d4af37]/50 transition-all"
                                    />
                                    <button
                                        type="button"
                ...
                <p className="mt-8 text-center text-gray-600 text-[10px] uppercase tracking-[0.3em] font-medium">
                    &copy; 2026 Golden Herbal Ltd. &bull; Secure Access Only
                </p>
            </div>
        </div>
    );
